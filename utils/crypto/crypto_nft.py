...
def mint_nft(description: str, image_url: str) -> dict:
    ...
    metadata = {"name": f"{collection_name}{next_token_id}", "description": description, "image": url}
...
def upload_image_from_url_to_s3(bucket_name, image_url, object_name=None):
    ...
    try:
        ...
        s3_client.upload_file(temp_file_path, bucket_name, object_name, ExtraArgs={"ContentType": content_type})
...
def upload_image_to_s3(bucket_name, image_path, object_name=None):
    ...
    try:
        ...
        s3_client.upload_file(image_path, bucket_name, object_name, ExtraArgs={"ContentType": content_type})
